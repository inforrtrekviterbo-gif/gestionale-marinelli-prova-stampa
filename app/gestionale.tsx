...
function Modal({ title, children, onClose }: { title: string; children: ReactNode; onClose: () => void }) {
  return <div className="modal-backdrop" role="dialog" aria-modal="true"><div className="modal"><div className="modal-head"><h2>{title}</h2><button className="icon-button" onClick={onClose} aria-label="Chiudi"><MaterialIcon>close</MaterialIcon></button></div>{children}</div></div>;
}
...
const adminMenu = [["dashboard", "dashboard", "Riepilogo"], ["manage", "edit_square", "Modifica e cancella"], ["cash", "point_of_sale", "Cassa"], ["customers", "group", "Clienti"], ["inventory", "inventory_2", "Magazzini"], ["reorder", "warning", "Articoli da riordinare"], ["transfers", "swap_horiz", "Trasferimenti"], ["load", "add_box", "Carico prodotti"], ["documents", "receipt_long", "Fatturazione"], ["register", "list_alt", "Registro casse"], ["reports", "summarize", "Corrispettivi"], ["gifts", "card_giftcard", "Riepilogo buoni regalo"], ["reservations", "event_note", "Prenotazioni e acconti"], ["analytics", "trending_up", "Analisi vendite"], ["fiscal", "print", "Registratori RT"], ["settings", "settings", "Impostazioni"]] as const;
